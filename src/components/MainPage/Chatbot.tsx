...
const Chatbot = ({
  ...
  const handleUpdate = (msg: { text: string; index: number }) => {
    ...
    const sectionPath = `structured_data.${sectionName}`;
    ...
    handleUpdateResume({
      ...
      text: msg.text,
      index: selectedSection[0].index,
      descIndex: selectedSection[0].i ?? 0, // Ensure descIndex is valid
    });
  };
            ...
            >
              ...
              {msg.sender !== "user" && (
                <div className="flex justify-end space-x-2 mt-2">
                  ...
                  <button className="bg-red-700 rounded-md p-1">Reject</button>
                </div>
              )}
            </div>
